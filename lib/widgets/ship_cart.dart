...
import 'package:monteirolojjja/correios/correios_frete.dart';
import 'package:monteirolojjja/correios/via_cep_service.dart';
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              onFieldSubmitted: (cepDigitado) async {
                ...
                final resultCep =
                    await ViaCepService.fetchCep(cep: cepDigitado);
                print(resultCep
                    .localidade); // Exibindo somente a localidade no terminal
                ...
                try {
                  ...
                  if (reponse.statusCode == 200) {
                    ...
                    CartModel.of(context).setShip(int.parse(correios.prazo),
                        double.parse(correios.valor.replaceAll(",", ".")));
